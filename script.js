const cryptoUrl =
  "https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,litecoin,ripple,bitcoin-cash,cardano,polkadot,chainlink,solana,binancecoin,stellar,dogecoin,usd-coin,uniswap,terra&vs_currencies=usd";
...
async function crypto() {
  try {
    ...
    (errorr.textContent =
      "Error at fetching crypto, Please wait or refresh page"),
      error;
  }
}
